 ...
 * pickers, the tags offered while typing `#` — so they share one compact size and
 * change together. A panel is a quick aside, not a form: its buttons stay smaller
 * than the screen's own. A menu on a phone is the exception (UI-49).
 */
