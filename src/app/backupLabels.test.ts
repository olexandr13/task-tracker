...
const NONE = { tasks: 0, lists: 0, completions: 0, redemptions: 0 }

describe('counting what a file holds', () => {
  it('names each kind there is, and leaves out the ones there are none of', () => {
    expect(describeRecordCounts({ tasks: 12, lists: 2, completions: 30, redemptions: 1 })).toBe(
      '12 tasks, 2 lists, 30 completions and 1 redemption',
    )
